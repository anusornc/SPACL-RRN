...
const TEST_CASES: &[(&str, &str, usize)] = &[
    ("Disjunctive_10K", "benchmarks/ontologies/disjunctive/disjunctive_10k.owl", 10000),
    ("Disjunctive_30K", "benchmarks/ontologies/disjunctive/disjunctive_30k.owl", 30000),
    ("Disjunctive_50K", "benchmarks/ontologies/disjunctive/disjunctive_50k.owl", 50000),
];
...
fn bench_sequential(c: &mut Criterion) {
    ...
    for (name, path, _) in TEST_CASES {
        ...
        println!("Testing {}: {} classes, ~{} disjunctions", name, class_count, disjunctions);
        
        group.bench_with_input(
            BenchmarkId::new(name, class_count),
            &ont,
            |b, ont| {
                b.iter(|| {
