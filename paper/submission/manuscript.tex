...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.32\linewidth]{scalability.pdf}\hfill
\includegraphics[width=0.32\linewidth]{speedup.pdf}\hfill
\includegraphics[width=0.32\linewidth]{throughput.pdf}
\caption{Synthetic scalability visual summary corresponding to Table~\ref{tab:scalability}: runtime trend (left), speedup over the sequential baseline (center), and throughput (right).}
