...
SPACL is available at \url{https://github.com/anusornc/tableauxx} under the MIT license. Reproducibility artifacts for this paper revision are included in the repository, including the primary head-to-head run (\texttt{benchmarks/competitors/results/history/head2head\_round4\_large\_full\_20260219\_rerun}) and stage-level parser A/B outputs referenced in Section~\ref{sec:realworld}. A detailed reproduction checklist is provided as supplementary project documentation (\texttt{paper/submission/LITERATURE\_REVIEW\_TODO\_CHECKLIST.md} and benchmark scripts under \texttt{benchmarks/competitors/scripts/}).
