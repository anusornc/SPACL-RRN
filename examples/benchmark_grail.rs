...
fn benchmark_grail(ontology: &Ontology, iterations: usize) -> Result<(Vec<std::time::Duration>, Vec<std::time::Duration>), Box<dyn std::error::Error>> {
    ...
    for i in 0..iterations {
        ...
        if i == 0 {
            ...
            println!("  Classes: {}, Edges: {}", 
                result.stats.classes_processed,
