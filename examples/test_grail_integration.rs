...
fn main() {
    ...
    let ontologies = vec![
        ...
        ("Hierarchy 100", "benchmarks/competitors/ontologies/hierarchy_100.owl"),
        ("Hierarchy 1000", "benchmarks/competitors/ontologies/hierarchy_1000.owl"),
        ("Hierarchy 10000", "benchmarks/competitors/ontologies/hierarchy_10000.owl"),
    ];
